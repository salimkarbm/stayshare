...
export class MalierService {
    ...
    async sendOTP(options: Mail) {
        if (options.OTP !== undefined && options.OTP.toString().length === 6) {
            ...
            <p>Welcome to <strong>Stayshare</strong>. Please verify your email address with the OTP code below. It would expire after 10 minutes.</p>
    ...
    async accountActivationMail(options: Mail) {
        ...
        Welcome to <strong>Stayshare</strong>,
